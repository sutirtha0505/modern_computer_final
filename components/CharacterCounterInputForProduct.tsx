  ...
  return (
    ...
    >
      <Image
        src={
          profilePhoto ||
          "https://keteyxipukiawzwjhpjn.supabase.co/storage/v1/object/public/product-image/Logo_Social/user.png"
        } // Fallback to a default image if profilePhoto is not available
        alt="Profile"
