  ...
  return (
    <div className='w-full pt-6 flex flex-col items-center p-6 gap-6'>
      ...
      <h1 className='text-2xl font-bold'>
        Offer for <span className='text-indigo-500'>Custom AMD-Build Products</span>
      </h1>
      <p className='text-medium p-6 text-center'>
        ...
        <span className='text-indigo-500'>Custom AMD-Build Products.</span> You'll also need to enter the <span className='text-indigo-500'>
        Discount percentage
